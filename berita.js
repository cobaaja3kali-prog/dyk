...
function addNews(item){ const list = getNews(); list.unshift(item); saveNews(list); showToast('Berita ditambahkan'); }
function deleteNews(idx){ const list = getNews(); list.splice(idx,1); saveNews(list); renderNewsList(list); renderAdminNews(); showToast('Berita dihapus'); }
