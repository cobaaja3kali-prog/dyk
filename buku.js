...
function addBook(book){ const list = getBooks(); list.unshift(book); saveBooks(list); showToast('Buku ditambahkan'); }
function deleteBook(idx){ const list = getBooks(); list.splice(idx,1); saveBooks(list); renderCatalog(list); renderAdminBooks(); showToast('Buku dihapus'); }
